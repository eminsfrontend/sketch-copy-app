...
export { default as Menu } from "./singleComponent/menu"
export { default as Navigation } from "./singleComponent/navigation"
export { default as Header } from "./singleComponent/header"
